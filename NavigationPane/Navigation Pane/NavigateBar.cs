 ...
 *
 * Description  : Navigation Pane Container Panel
 * 
 * Link         : http://www.codeproject.com/office/Outlook_Navigation_Pane.asp
 */
...
namespace MobileControls
{
    ...
    public class NavigateBar : ContainerControl, IComponent
    {
        ...
        #region OverFlowPanelVisible


        /// <summary>
        /// OverFlowPanel Visible
        /// <para>Get / Set</para>
        /// </summary>
        [Category("NavigationPane")]
        [Description("OverFlowPanel Visible")]
     
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Visible)]
        public bool IsOverFlowPanelVisible
        {
            get { return this.overFlowPanel.Visible; }
            set
            {
                this.overFlowPanel.Visible = value;
            }
        }
        ...
        #region NavButtonsSplitter
        
        /// <summary>
        /// used to hide the splitter above the buttons
        /// <para>Get / Set</para>
        /// </summary>
        [Category("NavigationButtons")]
        [Description("used to hide the splitter above the buttons")]
        [DefaultValue(true)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Visible)]
        public bool IsNavButtonSplitterVisible
        {
            get { return this.splitter.Visible; }
            set
            {
        ...
        void InitOutlookStyleNavigateBar()
        {
            ...
            navigateBarCaption.CaptionFont =new Font("Tahoma", 14, FontStyle.Bold);
            ...
            //relatedControlContainer.Dock = DockStyle.Fill;
        ...
        void ReSizeControlPanel()
        {
            ...
            try
            {
                ...
                relatedControlContainer.Height = Height - relatedControlContainer.Top - (visibleItemCount * this.NavigateBarButtonHeight); 

                if (overFlowPanel.Visible )
                    relatedControlContainer.Height = relatedControlContainer.Height - this.OverFlowPanelHeight;
                if (splitter.Visible )
                    relatedControlContainer.Height = relatedControlContainer.Height - splitter.Height;
